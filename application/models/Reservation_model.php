 ...
 class Reservation_model extends CI_Model
 {
 	...
 	public function load_reservation_history()
 	{
 		...
 		$this->db->select('reservation.id as reservation_id,reservation.date_from,reservation.date_to,reservation.quantity,reservation.total_amount,reservation.timestamp,reservation.status,reservation.payment_type,reservation.reason,
 			amenity.description,
 	...
 	public function load_reservation_request()
 	{
 		...
 		$this->db->select('reservation.id as reservation_id,reservation.date_from,reservation.date_to,reservation.quantity,reservation.total_amount,reservation.timestamp,reservation.payment_type,reservation.reason,
 			amenity.description,
 			resident.first_name,resident.last_name
 			');
 		$this->db->from('reservation_tbl as reservation');
 	...
 	public function reject_request($reservation_id, $remarks)
 	{
 		$update_data = [
 			'status' => 'REJECTED',
 	...
 	{
 		$this->db->where('id', $id);
 		$this->db->update('reservation_tbl', ['status'=> 'CANCELLED']);
 		$affected_row = $this->db->affected_rows();
