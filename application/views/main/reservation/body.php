...
<div class="modal fade" tabindex="-1" role="dialog" id="cancel_request_modal">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<textarea class="w-100" id="cancel_request_reason" readonly=""></textarea>
				<input type="hidden" id="cancel_request_hidden_id">
			</div>
			<div class="modal-footer">
				<button class="btn btn-info" onclick="AMENITY.cancel_request()">Approved Cancellation</button>
			</div>
		</div>
	</div>
</div>